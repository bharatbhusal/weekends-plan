	...
	return (
		<div className="min-h-screen bg-background">
						...
						<div className="space-y-4">
							...
							{isCalendar ? (
								<CalendarView
									...
									onSelectDayEvents={(date, evts) =>
										setSelectedDayEvents({ date, events: evts })
									}
								/>
							) : (
			...
			<Drawer
				...
				onOpenChange={(open) =>
					!open && setSelectedDayEvents(null)
				}
			>
